 ...
 */
 ...
 function myAnimalWithLog(){
    console.log('My favorite animal is Wolf');
 }

 function myAnimalWithWarn(){
     console.warn("My favorite animal is Wolf");
 }

 function myAnimalWithError(){
     console.error("My favorite animal is Wolf");
 }

 function myCity(){
     console.alert("My favorite city is Lagos");
 }
 myCity();
global.console = {
	log: jest.fn(),
